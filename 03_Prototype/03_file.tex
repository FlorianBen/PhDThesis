...
\begin{refsection}
  ...
  \subsection{Results}
  % Using the code, it has been shown that space charge effect can be partially compensated by a high extraction field value. It has been seen that profiles from electrons seem to be more affected by space charge effect than from ions.
