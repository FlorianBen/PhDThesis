\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \draw[] (\LIPM,0) node[right,align=left] {Field\\correctors};


		% Beam
		\draw[fill=blue!30] (0,0) circle (0.4) node[left] {Beam};
		% Cage
    ...
    \draw[blue,dashed,->] (-0.1,0.05)--(-0.1,\LIPM);
    \draw[blue,fill=blue] (-0.1,0.05) circle [radius=1mm] node[] {\tiny\color{white}{$-$}};

    \draw[red,dashed,->] (-0.1,-0.09)--(-0.1,-\LIPM);
    \draw[red,fill=red] (-0.1,-0.09) circle [radius=1mm] node[] {\tiny\color{white}{$+$}};
