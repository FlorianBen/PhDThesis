...
\begin{refsection}
  ...
  % The history of ESS is quite complex, the first studies and design for ESS date back to the 1990s. These designs have changed a lot over the years as well as the existing technologies.
  ...
  \input{02_BeamDiag/tables/table002_ess_instruments}
  \vspace{1cm}
  ...
  \input{02_BeamDiag/figures/fig000_CT}
  ...
  These diagnostics can be developed in-house or purchased directly off the shelf. At ESS \cite{Hassanzadegan:IPAC2018-WEPAF088}, 18 ACCTs from Bergoz Instrumentation \cite{bergoz2019} will be installed along the accelerator to measure the current. % \footnote{2 FCT are used in the MEBT}
  ...
  % TODO: Few or some
  \input{02_BeamDiag/figures/fig000_BPM_button}
  ...
  \input{02_BeamDiag/figures/fig000_icBLM}
  ...
  \input{02_BeamDiag/figures/fig000_FPM.tex}
