...
\newcommand{\ecodoctitle}{Particules Hadrons \'{E}nergie, Noyeau, Instrumentation, Image, Cosmos et Simulation} 													%% Nom de l'ED. Voir site de l'Université Paris-Saclay / Full name of Doctoral School. See Université Paris-Saclay website
...
\begin{textblock}{5}(0.0,0.0)
	...
	%\vspace{10mm}
	\includegraphics [scale=0.90]{00_Guards/media/bande.png}
	\vspace{300mm}
\end{textblock}
...
\begin{textblock}{1}(\hpostt,\vpostt)
	...
	\includegraphics[scale=1]{00_Guards/media/etab/\logoEtt.png}
\end{textblock}

\begin{textblock}{1}(\hpos,\vpos)
	\textblockcolour{white}
	\includegraphics[scale=1]{00_Guards/media/etab/\logoEt.png}
\end{textblock}
