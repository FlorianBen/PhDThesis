...
\newcommand{\PhDTitle}{Design of non-invasive profile monitors for the ESS proton beam\\[2\baselineskip]Conception de profileurs non invasifs pour le faisceau de protons de ESS} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Florian Benedetti} 															%% Civilité, nom et prénom /  Civility, first name and name 
\newcommand{\NNT}{2019SACLS238} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)

\newcommand{\ecodoctitle}{Particules, Hadrons, \'{E}nergie, Noyau, Instrumentation, Image, Cosmos et Simulation} 													%% Nom de l'ED. Voir site de l'Université Paris-Saclay / Full name of Doctoral School. See Université Paris-Saclay website
...
\newcommand{\PhDspeciality}{Physique des accélérateurs} 										%% Spécialité de doctorat / Speciality 
\newcommand{\PhDworkingplace}{l'Université Paris-Sud et au \\Commissariat à l'Énergie Atomique et aux Énergies Alternatives\\au sein du \\Département d'Électronique, des Détecteurs et de l'Informatique pour la Physique\\de
l'Institut de Recherche sur les lois Fondamentales de l'Univers} 										%% Établissement de préparation / PhD working place : l'Université Paris-Sud, l'Université de Versailles-Saint-Quentin-en-Yvelines, l'Université d'Evry-Val-d'Essonne, l'Institut des sciences et industries du vivant et de l'environnement (AgroParisTech), CentraleSupélec,l'Ecole normale supérieure de Cachan, l'Ecole Polytechnique, l'Ecole nationale supérieure de techniques avancées, l'Ecole nationale de la statistique et de l’administration économique, HEC Paris, l'Institut d'optique théorique et appliquée, Télécom ParisTech, Télécom SudParis   
\newcommand{\defenseplace}{Saclay} 											%% Ville de soutenance / Place of defense
\newcommand{\defensedate}{23 septembre 2019} 															%% Date de soutenance / Date of defense
...
\newcommand{\vposa}{0.25}
\newcommand{\vposb}{0.25}
\newcommand{\vposc}{0.25}

\newcommand{\hposa}{12.1}
\newcommand{\hposb}{9.3}
\newcommand{\hposc}{5.9}																		
...
\newcommand{\jurynameA}{Patrick Puzo}
\newcommand{\juryadressA}{Professeur, Université Paris-Sud}
\newcommand{\juryroleA}{Président}

%%% Membre n°2 (Rapporteur) / Member n°2 (Reviewer)
\newcommand{\jurynameB}{Gloria Luz\'{o}n}
\newcommand{\juryadressB}{Professeure, Universidad de Zaragoza}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (Reviewer)
\newcommand{\jurynameC}{Peter Forck}
\newcommand{\juryadressC}{Chercheur sénior, GSI Darmstadt}
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameD}{Julien Pancin}
\newcommand{\juryadressD}{Ingénieur-chercheur, CEA Ganil}
\newcommand{\juryroleD}{Examinateur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{Cyrille Thomas}
\newcommand{\juryadressE}{Ingénieur-chercheur, ESS Lund}
\newcommand{\juryroleE}{Examinateur}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Esther Ferrer Ribas}
\newcommand{\juryadressF}{Ingénieure-chercheuse, CEA Saclay}
\newcommand{\juryroleF}{Directrice de thèse}

%%% Membre n°7 (Invité) / Member n°7 (Guest)
\newcommand{\jurynameG}{Jacques Marroncle}
\newcommand{\juryadressG}{Ingénieur-chercheur, CEA Saclay}
...
\begin{textblock}{1}(\hposa,\vposa)
	\textblockcolour{white}
		\includegraphics[scale=1]{media/etab/\logoEt.png}	
\end{textblock}

\begin{textblock}{1}(\hposb,\vposb)
	\textblockcolour{white}
		\includegraphics[scale=0.358]{Logos/irfu_logo.jpg}	
\end{textblock}

\begin{textblock}{1}(\hposc,\vposc)
	\textblockcolour{white}
		\includegraphics[scale=0.12]{Logos/Pheniics.png}	
\end{textblock}
