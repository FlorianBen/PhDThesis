...
\newcommand{\NNT}{20XXSACLS238} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\newcommand{\hposa}{13}
\newcommand{\hposb}{9}
\newcommand{\hposc}{9}																		%% À modifier au besoin pour aligner le logo horizontalement / If needed, modify to align logo horizontaly
...
\begin{textblock}{1}(\hposb,\vposb)
	\textblockcolour{white}
		\includegraphics[scale=0.15]{Logos/CEA.png}	
\end{textblock}
