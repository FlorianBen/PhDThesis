...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node [anchor=north, yshift=-3.1 cm, text width=18cm, inner sep=.3cm] (resume) at (current page.north) {
    ...
    These studies were the object of the Preliminary Design Review that marked the beginning of the construction phase of the different prototypes. Preliminary tests discarded the possibility of using silicon detectors with low energetic ions. Finally, beam measurements were carried out during two test campaigns at IPHI, a $3\,\mathrm{MeV}$ linear proton accelerator at CEA Saclay. Both types of detectors performed well and the results were compared with other diagnostics. The tests also permitted to check the characteristics of the profilers under conditions close to the ESS ones. The results of the prototypes were presented during the Critical Design Review leading to the beginning of the production phase.
  };
